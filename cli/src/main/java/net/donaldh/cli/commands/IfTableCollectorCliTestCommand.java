 ...
 */
package net.donaldh.cli.commands;

import org.apache.karaf.shell.commands.Command;
import org.apache.karaf.shell.commands.Option;
import org.apache.karaf.shell.console.AbstractAction;
import net.donaldh.cli.api.IfTableCollectorCliCommands;
...
public class IfTableCollectorCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(IfTableCollectorCliTestCommand.class);
    protected final IfTableCollectorCliCommands service;

    public IfTableCollectorCliTestCommand(final IfTableCollectorCliCommands service) {
